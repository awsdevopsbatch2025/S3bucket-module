...
# --- NEW OUTPUT FOR MIRRORED PUBLIC ACCESS BLOCK (PAB) CONFIGURATION ---
output "public_access_block_config" {
  description = "The Public Access Block configuration applied to the bucket."
  value = {
